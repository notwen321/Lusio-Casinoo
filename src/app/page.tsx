    ...
    return (
        <StyledWrapper>
            <div className="relative">
                ...
                <Image src="/assets/image/logo.png" alt="logo" className="w-44 fixed top-5 left-5 z-20" />
                ...
                <div className="absolute w-screen h-screen z-10 bg-black/70 top-0">
                    <div className="relative w-screen h-screen">
                        <div className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 flex items-center flex-col">
                            ...
                            <h1 className="text-[200px] text-white masked-text px-12">Lusio</h1>
                            <p className="text-white text-2xl">
                                Betting means you are not alone!
                            </p>
                            
                            {/* Connect Wallet or Enter Casino Button */}
                            {currentAccount ? (
                                <Link href={"/landing"}>
                                    <Button className="synthwave-laser-button mt-8">Enter Casino</Button>
                                </Link>
                            ) : (
                                <div className="mt-8">
                                    <ConnectButton className="synthwave-laser-button" />
                                </div>
                            )}
                        </div>
                    </div>
